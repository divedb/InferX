...
M4's original server used cpp-httplib but has since migrated to the planned
Boost.Beast/Asio event-driven transport. Its tokenizer was delivered as our own
byte-level BPE rather than FFI to the Rust `tokenizers` — asserted against a 140-string
